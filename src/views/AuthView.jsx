        ...
        {hasSupabase && (
          <>
            ...
            >
              {googleLoading ? (
                <>
                  <span className="inline-block w-5 h-5 border-2 border-slate-300 border-t-slate-600 dark:border-brand/30 dark:border-t-brand rounded-full animate-spin" aria-hidden />
                  <span>מתחבר...</span>
                </>
              ) : (
                <>
