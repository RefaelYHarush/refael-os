      ...
      <Card className="w-full max-w-md p-6 shadow-xl" onClick={(e) => e.stopPropagation()} dir="rtl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-2 pt-2 flex-wrap">
            ...
            <button type="submit" className="flex-1 min-w-[80px] py-2 rounded-lg bg-brand-dark text-white hover:bg-brand-dark/90 font-bold shadow-lg shadow-brand-dark/20">
              שמירה
            </button>
          </div>
        </form>
